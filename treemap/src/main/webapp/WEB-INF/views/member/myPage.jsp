	...
	<div class="myPage-body">
		<div class="myPageBoxWrapper">
			...
			<div class="myPageBox">
				...
				<span class="myPageInfo">${member.userName}</span>
				<button class="changeInfo" id="userName" onclick="document.querySelector('#nameModal').style='display:block';">이름 변경</button>
			</div>
			<div class="myPageBox">
			...
			<div class="myPageBox">
					...
					<span class="myPageInfo">${member.userEmail}</span>
			</div>
			<div class="myPageBox">
				<label class="myPageLabels">Password</label>
				<button class="changeInfo" id="userPW" style="height:27px;" onclick="document.querySelector('#passwordChkModal').style='display:block';">비밀번호 변경</button>	
			</div>
		</div>
	</div>
	 ...
	 <div id="passwordChkModal" class="myPageModal">
		...
		<div class="myPageModal-content">
			...
			<div class="myPageBtnBox" style="width: 100%; margin-top:20px;">
				...
				<div class="myPageBtnBox">
					<button class="myPageBtn" onclick="document.querySelector('#passwordChkModal').style='display:none';">
								<span class="pop_bt" style="font-size: 10pt;"> 취소 </span>
					</button>
				</div>		
			</div>
	...
	<div id="passwordModal" class="myPageModal">
		...
		<div class="myPageModal-content">
			...
			<div class="myPageBtnBox" style="width: 100%; margin-top:20px;">
				...
				<div class="myPageBtnBox">
					<button class="myPageBtn" onclick="document.querySelector('#passwordModal').style='display:none';">
								<span class="pop_bt" style="font-size: 10pt;"> 취소 </span>
					</button>
				</div>		
			</div>
